...
The script on GitHub has file pathways omitted for security issues. You will need to copy and paste the appropriate file paths at the beginning of the script.

*Copy and paste the following commands* in the code chunk starting under **line 116**.

conn <- odbcConnect("ilmocAIMPub")
...
TerrADatPath <- "C:/Users/rburke/GDBs/SDE_Export.gdb"
...
#Connect to TerrADat Species Indicator
#TerrADat_Species <- sqlQuery(conn, 'SELECT * FROM ilmocAIMPub.ilmocAIMPubDBO.TerrADatSpeciesIndicators;')

#Connect to LMF Species Indicator
#LMF_Species <- sqlQuery(conn, 'SELECT * FROM ilmocAIMPub.ilmocAIMPubDBO.LMFSpeciesIndicators;')

#Connect to species list
#SpeciesList <- sqlQuery(conn, 'SELECT * FROM ilmocAIMPub.ilmocAIMPubDBO.tblStateSpecies;')
